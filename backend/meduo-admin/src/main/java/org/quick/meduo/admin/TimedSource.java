...
public class TimedSource {
	...
	@StreamListener(TimedChannel.INPUT)
	@SendTo(TimedChannel.OUTPUT)
	public Object handle(Object message) {
//		output.output().send(MessageBuilder.withPayload(message.toString().getBytes(StandardCharsets.UTF_8)).build());
		return message;
	}
}
