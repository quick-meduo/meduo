...
import org.quick.meduo.tools.json.test.bean.JSONBean;
import org.quick.meduo.tools.json.test.bean.ResultDto;
import org.quick.meduo.tools.json.test.bean.Seq;
import org.quick.meduo.tools.json.test.bean.TokenAuthResponse;
import org.quick.meduo.tools.json.test.bean.TokenAuthWarp2;
import org.quick.meduo.tools.json.test.bean.UserA;
import org.quick.meduo.tools.json.test.bean.UserB;
import org.quick.meduo.tools.json.test.bean.UserWithMap;
import org.quick.meduo.tools.json.test.bean.report.CaseReport;
import org.quick.meduo.tools.json.test.bean.report.StepReport;
import org.quick.meduo.tools.json.test.bean.report.SuiteReport;
import lombok.Data;
