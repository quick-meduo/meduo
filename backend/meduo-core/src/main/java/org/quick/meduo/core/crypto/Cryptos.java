...
package org.quick.meduo.core.crypto;


import org.quick.meduo.common.utils.Encodes;
import org.quick.meduo.common.utils.XORUtils;
...
public class Cryptos {
    ...
    public static String XOREncode(String res, String key){
        return  XORUtils.getInstance().encode(res,key);
    }

    public static String XORDecode(String res, String key){
        return  XORUtils.getInstance().decode(res,key);
    }
}
