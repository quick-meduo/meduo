...
const isOpen = true
Mock.on(isOpen, /\/org\/tree/, 'get', orgTree)
Mock.on(isOpen, /\/role/, 'get', role)
Mock.on(isOpen, /\/permission\/no-pager/, 'get', permissionNoPager)
Mock.on(isOpen, /\/permission/, 'get', permissions)
